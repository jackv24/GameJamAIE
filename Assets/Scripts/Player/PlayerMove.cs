...
public class PlayerMove : MonoBehaviour
{
    ...
    void Update()
    {
        if(controller)
        {
            ...
            if (((playerInput.ControllerConnected ? playerInput.jump.WasPressed : false) || (playerInput.controllerIndex < 1 ? Input.GetButtonDown("Jump") : false)) && GameManager.instance.gameRunning)
            {
